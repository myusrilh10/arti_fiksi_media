...
import { ARTICLES, EVENTS, VIDEOS } from "@/lib/data";
            ...
            {EVENTS.map((event) => (
              <Link key={event.id} href={`/events/${event.slug}`} className="block group">
                <motion.div
                  ...
                  className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300 h-full flex flex-col"
                >
