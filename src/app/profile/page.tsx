    ...
    return (
        <div className="container mx-auto px-4 py-12 md:px-6">
            ...
            <section className="mb-16 grid gap-12 md:grid-cols-2 items-center">
                ...
                <div className="relative aspect-video w-full bg-gray-200 rounded-lg overflow-hidden border border-gray-300">
                ...
                <div className="grid gap-6 md:grid-cols-3 lg:grid-cols-4">
                    {[1, 2, 3, 4].map((i) => (
                        <div key={i} className="group">
                            <div className="relative aspect-square bg-gray-200 mb-4 overflow-hidden rounded-md">
                                <div className="absolute inset-0 flex items-center justify-center text-gray-400">
                                    Team Member {i}
                                </div>
                            </div>
                            <h4 className="font-bold text-black group-hover:text-primary transition-colors">Nama Anggota {i}</h4>
